...
def is_speaking(df_meeting, sampleDelay=50, clipping_value=120, avg_speech_power_threshold=42, frame_size=1000, median_window=120):
    ...
    # Find the badge with the highest power reading at every sample interval and declare it to be the main speaker
    df_is_winner = df_power.apply(lambda x: x == df_max_power)
